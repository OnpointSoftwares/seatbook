 ...
 echo "<div class='row marketing' style='background-image: linear-gradient(blue,yellow);width: 200px;border:6px solid blue'>
        <ul style='list-style: none'>
          ...
          <li>Seat ".$row['SeatId']."</li><input type='text' name='Id' value='".$row['SeatId']."' hidden>
             ...
             ?>
                <li><button onclick="window.confirm('Are you sure you want to book?')" name="book" type="submit" class='btn btn-lg btn-success' style='height:40px'>Book</button></li>
          </ul></form>
...
echo $seatId;
echo $occupant;
$sql1="update seats set Occupant='$occupant',Status='occupied' where SeatId='$seatId'";
